...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"><i
			class="fas fa-clinic-medical"></i> HEALTH CARE CENTER</a>
				...
				<c:if test="${not empty userObj}">
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1"
							style="position: absolute; left: -54px;">
							<li><a class="dropdown-item" href="change_password.jsp"><b>Change
										Password</b></a></li>
							<li><a class="dropdown-item" href="userLogout"><b>Logout</b></a></li>
